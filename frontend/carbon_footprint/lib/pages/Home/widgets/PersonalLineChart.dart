...
class PersonalCarbonUsageLineChart extends StatefulWidget {
  const PersonalCarbonUsageLineChart({super.key});

  @override
  State<PersonalCarbonUsageLineChart> createState() =>
      _PersonalCarbonUsageLineChartState();
}

class _PersonalCarbonUsageLineChartState
    extends State<PersonalCarbonUsageLineChart> {
